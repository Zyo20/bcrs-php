...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    $_SESSION['error_message'] = "Invalid masterlist entry ID";
...
// Fetch the masterlist entry
try {
    $stmt = $db->prepare("SELECT * FROM masterlist WHERE id = ?");
    $stmt->execute([$id]);
    $entry = $stmt->fetch(PDO::FETCH_ASSOC);
    
    if (!$entry) {
        $_SESSION['error_message'] = "Masterlist entry not found";
        header("Location: index.php?page=admin&section=masterlist");
        exit;
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        try {
            $stmt = $db->prepare("UPDATE masterlist SET last_name = ?, first_name = ?, middle_name = ?, contact_number = ?, age = ?, year_of_residency = ?, purok = ? WHERE id = ?");
            $stmt->execute([$last_name, $first_name, $middle_name, $contact_number, $age, $year_of_residency, $purok, $id]);
            
            $_SESSION['success_message'] = "Masterlist entry updated successfully!";
            header("Location: index.php?page=admin&section=masterlist");
            exit;
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-blue-800">Edit Masterlist Entry</h1>
        ...
        <div class="p-6">
            <div class="mb-4">
                <h2 class="text-xl font-semibold text-gray-800">
                    <i class="fas fa-user-edit mr-2"></i> Edit Masterlist Entry
                </h2>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                               ...
                               value="<?php echo isset($_POST['last_name']) ? htmlspecialchars($_POST['last_name']) : htmlspecialchars($entry['last_name']); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                               ...
                               value="<?php echo isset($_POST['first_name']) ? htmlspecialchars($_POST['first_name']) : htmlspecialchars($entry['first_name']); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                               ...
                               value="<?php echo isset($_POST['middle_name']) ? htmlspecialchars($_POST['middle_name']) : htmlspecialchars($entry['middle_name'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                               ...
                               value="<?php echo isset($_POST['contact_number']) ? htmlspecialchars($_POST['contact_number']) : htmlspecialchars($entry['contact_number']); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                               ...
                               value="<?php echo isset($_POST['age']) ? htmlspecialchars($_POST['age']) : htmlspecialchars($entry['age']); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                               ...
                               value="<?php echo isset($_POST['year_of_residency']) ? htmlspecialchars($_POST['year_of_residency']) : htmlspecialchars($entry['year_of_residency']); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                            ...
                            <option value="Purok 1" <?php echo (isset($_POST['purok']) && $_POST['purok'] === 'Purok 1') || (!isset($_POST['purok']) && $entry['purok'] === 'Purok 1') ? 'selected' : ''; ?>>Purok 1</option>
                            <option value="Purok 2" <?php echo (isset($_POST['purok']) && $_POST['purok'] === 'Purok 2') || (!isset($_POST['purok']) && $entry['purok'] === 'Purok 2') ? 'selected' : ''; ?>>Purok 2</option>
                            <option value="Purok 3" <?php echo (isset($_POST['purok']) && $_POST['purok'] === 'Purok 3') || (!isset($_POST['purok']) && $entry['purok'] === 'Purok 3') ? 'selected' : ''; ?>>Purok 3</option>
                            <option value="Purok 4" <?php echo (isset($_POST['purok']) && $_POST['purok'] === 'Purok 4') || (!isset($_POST['purok']) && $entry['purok'] === 'Purok 4') ? 'selected' : ''; ?>>Purok 4</option>
                            <option value="Purok 5" <?php echo (isset($_POST['purok']) && $_POST['purok'] === 'Purok 5') || (!isset($_POST['purok']) && $entry['purok'] === 'Purok 5') ? 'selected' : ''; ?>>Purok 5</option>
                            <option value="Purok 6" <?php echo (isset($_POST['purok']) && $_POST['purok'] === 'Purok 6') || (!isset($_POST['purok']) && $entry['purok'] === 'Purok 6') ? 'selected' : ''; ?>>Purok 6</option>
                        </select>
                    </div>
                </div>
